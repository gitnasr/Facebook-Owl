const PrivacyPage: React.FC = () => {
  return (
    <section className=" prose mx-auto p-7 w-full">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Facebook Owl.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Facebook Owl, accessible from{' '}
            <a
              href='https://owl.gitnasr.com/'
              rel='external nofollow noopener'
              target='_blank'
            >
              https://owl.gitnasr.com/
            </a>
          </p>
        </li>
        <li>
