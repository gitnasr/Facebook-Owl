...
import { ItemUrl } from '@/constant/env';
          ...
          <div className='mx-auto mt-4 flex flex-col gap-4 md:mt-0 md:flex-row'>
            <div className='flex  flex-col'>
              <Link
                href={ItemUrl}
                target='_blank'
                className='items-center gap-2 rounded-xl bg-gradient-to-r from-amber-600 to-violet-600 px-4 py-2 font-medium text-black shadow-lg ring-1 hover:bg-gray-100 hover:shadow-sm hover:ring-0 '
              >
            ...
            <button className='h-fit rounded-xl bg-orange-700 px-4  py-2  text-white hover:bg-orange-600'>
              <Link
                href='https://youtu.be/9KnB5QccVSg'
                target='_blank'
